            ...
            <div className="d-flex justify-content-center">
                <div className="box-text-title">
                    <div style={{position:"relative"}}>
                        {isTabletOrMobile ?
                        <><p className="main-text  mb-4" >Discover exceptional talent with  our A.I powered search engine<div className="pos-under-text">
...
or reference image. Empowering you to find the perfect talent for your project</p>
                        ...
                        : 
                        <><p className="main-text">Discover exceptional talent with <br/> our A.I powered search engine<div className="pos-under-text">
                        <img src="/images/bar.png" alt="bar" />
                    </div></p>
...
or reference image. Empowering you to find the perfect talent for your project</p></>
            ...
            <div className="d-flex justify-content-center">
                ...
                <div className="box-img-video-minimal my-5">
                    ...
                    <video src="/images/main aida.mp4" autoPlay loop controls muted className="minimal-player"></video>
